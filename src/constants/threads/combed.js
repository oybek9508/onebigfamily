...
const imageArrays = (arr, imgNo) => {
	return arr.map((img, idx) => {
		let imageObj = {
			id: idx + 1,
			original: `/assets/images/threads/combed/images${imgNo}/img${img}.jpg`,
			thumbnail: `/assets/images/threads/combed/images${imgNo}/img${img}.jpg`,
		};
